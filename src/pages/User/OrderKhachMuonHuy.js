...
const OrderKhachMuonHuy = () => {
    ...
    useEffect(() => {
        fetchOrders(pageNumber, pageSize, 'KhachMuonHuy');
    ...
    const handleEditStatus_Hdb = async (maHdb, endpoint, newstatus) => {
        try {
            ...
            if (response.status === 200) {
                ...
                fetchOrders(pageNumber, pageSize, 'ChoXacNhan');
    ...
    return (
        <div className="max-w-5xl mx-auto p-8 bg-gray-50 min-h-screen">
            ...
            <h2 className="text-4xl font-bold text-center text-gray-900 mb-10">Danh sách hóa đơn muốn hoàn</h2>
                    ...
                    {invoices.data.map((hoaDon) => (
                        ...
                        >
                            ...
                            <div className="flex space-x-4 mb-6">
                                <button
                                    className="bg-yellow-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
                                    onClick={() =>
...
export default OrderKhachMuonHuy;

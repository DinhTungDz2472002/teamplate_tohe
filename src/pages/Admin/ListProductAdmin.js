//hoàn thiện nhưng k có search theo loại và ô search
...
//                 <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden scolbar">
...
export default function ListProductAdmin() {
    ...
    return (
        // <div className="p-5">
        //     <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6 p-4 bg-white rounded-lg shadow-sm">
        //         {/* Add Product Button */}
        //         <button
        ...
        //                 className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors duration-200 bg-white text-gray-900"
        //             >
        ...
        //                 className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors duration-200 placeholder-gray-500 text-gray-900"
        ...
        //                 className="w-full md:w-32 px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors duration-200 bg-white text-gray-900"
        //             >
        //                 {[8, 10, 20, 30].map((size) => (
        //                     <option key={size} value={size}>
        //                         {size} Sản phẩm
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-x-auto">
                <table className="min-w-[700px] w-full divide-y divide-gray-200">
                    <thead className="bg-gray-100">
                        <tr>
                            <th className="py-3 px-4 text-left text-sm font-semibold text-gray-900 min-w-[80px]">ID</th>

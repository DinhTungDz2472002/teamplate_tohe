//tạm được nhưng chưa có phần profile cart trong mobile
...
//                                     to="/Profile"
//                                     title="Profile"
//                                     className="flex items-center justify-center w-9 h-9 text-white bg-black rounded-full"
//                                     onClick={() => setMenuOpen(false)}
//                                 >
...
//             {/* Mobile Menu */}
//             {menuOpen && (
//                 <nav className="py-4 bg-[rgba(255,255,255,0.5)] lg:hidden">
//                     <div className="px-4 mx-auto sm:px-6 lg:px-8">
//                         <div className="flex items-center justify-between">
//                             <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">Menu</p>
//                             <button
//                                 type="button"
//                                 onClick={() => setMenuOpen(false)}
//                                 className="inline-flex p-2 text-black rounded-md focus:bg-gray-100 hover:bg-gray-100"
//                             >
//                                 <svg
//                                     className="w-6 h-6"
//                                     xmlns="http://www.w3.org/2000/svg"

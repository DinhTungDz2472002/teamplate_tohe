                ...
                <div className="relative group shadow-lg rounded-2xl overflow-hidden bg-white p-4 hover:shadow-2xl transition-all duration-300">
                    {/* <div className="overflow-hidden aspect-w-1 aspect-h-1">
                        <img
                            ...
                            onError={(e) => (e.target.src = `/assets/images/${product.anhSp}.png`)} // Nếu không tìm thấy ảnh jpg, thử png
                        />
                    </div> */}
                    <div className="relative rounded-md overflow-hidden w-full pt-[100%]">
                        <img
                            ...
                            src={`/assets/images/${product.anhSp}.jpg`}
                            alt={product.tenSanPham}
                            onError={(e) => (e.target.src = `/assets/images/${product.anhSp}.png`)} // fallback nếu ảnh jpg không có
                        />
                    </div>
                    {/* tên sản phẩm */}
